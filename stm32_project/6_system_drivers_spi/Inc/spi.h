...
typedef enum
{
	...
	SPI_STATE_BUST_TX = 0x03U,
	SPI_STATE_BUST_RX = 0x04U
...
#define SPI_DATASIZE_16BIT       	(SPI_CR1_CRCL)

#define SPI_POLARITY_LOW   	    	(0x00000000U)
#define SPI_DATASIZE_HIGH        	(SPI_CR1_CPOL)

#define SPI_PHASE_1EDGE         	(0x00000000U)

#define SPI_NSS_SOFT             	(SPI_CR1_SSM)

#define SPI_BAUDRATEPRESCALAR_4 	(SPI_CR1_BR_0)
